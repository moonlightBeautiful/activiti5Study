...
/**
 * 多用户分配：流程中写死 用户1,用户2,用户3 candidateUsers
 */
public class AssignTest1 {
    ...
    public static void main(String[] args) {
       ...
       /*Deployment deployment = processEngine.getRepositoryService()
                .createDeployment()
                .addClasspathResource("diagrams/multiUsers01.bpmn")
                .addClasspathResource("diagrams/multiUsers01.png")
                .name("多用户分配流程01")
                .deploy();
        ...
        /*ProcessInstance processInstance = processEngine.getRuntimeService()
                .startProcessInstanceByKey("multiUsers01");
        ...
        /**
         * 结束正在运行的流程任务：附带连接线条件变量
         */
        /*Map<String, Object> conditions =new HashMap<String,Object>();
        conditions.put("msg", "一般情况");
        processEngine.getTaskService()
                .complete("15004",conditions);*/
